            ...
            <div className="body">
                <div class="body" ref={el => { this.componentRef = el }}>
                    ...
                    <div class="div3">
                        ...
                        <p> &ensp;&ensp;&ensp;&ensp;Vu la demande présentée par : Mr <b>{input1}</b> : Professeur <b>{input2}</b> à l’Ecole Nationale des Sciences Appliquées d’El Jadida.</p>
                    </div>
                    <div class="div2">
                        <h3>Le Directeur<br />
                    ...
                    <div class="div3">
                        ...
                        <p class="div3-p">
                            Mr <b>{input5}</b> : Professeur <b>{input6}</b> à l’Ecole
                            ...
                            en mission à l’Université de <b>{input7}</b>.
                        </p>
                        <b><u>Article 2</u>   : </b><p style={{ display: 'inline' }}>L’intéressé est tenu d'aviser l’Ecole Nationale des Sciences Appliquées
                            dès sa reprise de &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;service à l'expiration de cette autorisation.</p>
                    </div>
                    <div class="div3">
